...
#------------------------------------------------
# 리스트 컨프리핸션
blist = [x for x in range(1, 7)]
print(blist)

blist = [x**2 for x in range(1, 7)]
print(blist)

blist = [x for x in range(1, 7) if x % 2 == 1]
print(blist)
...
data = (1, 2, 3, 2, 1, 4, 5)
alist = [x for x in data]
print(alist)

best = {x for x in data}
print(best)

#-------------------------------------------
# 딕셔러니 컨프리핸션
data = (2, 3, 4)
adict = {n: n**2 for n in data}
print(adict)
